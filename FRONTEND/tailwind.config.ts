  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        nexus: {
          charcoal: "hsl(var(--nexus-charcoal))",
          midnight: "hsl(var(--nexus-midnight))",
      ...
      backgroundImage: {
        "grid-pattern": "linear-gradient(hsl(var(--nexus-cyan) / 0.03) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--nexus-cyan) / 0.03) 1px, transparent 1px)",
